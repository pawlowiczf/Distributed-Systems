...
public interface CalculatorPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default float getAverageNumber(int[] numbers)
        throws NoInput
    {
        return getAverageNumber(numbers, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float getAverageNumber(int[] numbers, java.util.Map<String, String> context)
        throws NoInput
    {
        try
        {
            return _iceI_getAverageNumberAsync(numbers, context, true).waitForResponseOrUserEx();
        }
        catch(NoInput ex)
        {
            throw ex;
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Float> getAverageNumberAsync(int[] numbers)
    {
        return _iceI_getAverageNumberAsync(numbers, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> getAverageNumberAsync(int[] numbers, java.util.Map<String, String> context)
    {
        return _iceI_getAverageNumberAsync(numbers, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> _iceI_getAverageNumberAsync(int[] iceP_numbers, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getAverageNumber", null, sync, _iceE_getAverageNumber);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeIntSeq(iceP_numbers);
                 }, istr -> {
                     float ret;
    ...
    /** @hidden */
    static final Class<?>[] _iceE_getAverageNumber =
    {
        NoInput.class
    };
